...
import cornerstoneMath from './cornerstoneMath'
...
var cornerstoneTools = (function ($, cornerstone, cornerstoneMath, cornerstoneTools) {
    ...
    function onTouch(e) {
        ...
        if (e.type === 'transform') {
            ...
            lastScale = e.gesture.scale;
            var tranformEvent = {
                event: e, viewport: cornerstone.getViewport(element), mage: cornerstone.getEnabledElement(element).image, element: element,
                direction: scale < 0 ? 1 : -1
            };
